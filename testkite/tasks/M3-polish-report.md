...
| **Hoãn** | 3 | 3 mục, mỗi mục có địa chỉ milestone/điều kiện (NIT 1+14 ban đầu xếp hoãn, kiểm lại thấy `c0c2f42` đã sửa — xem 2.2). **Cả ba đã đóng sổ 31-08** qua đợt M3-debt: NIT 73 `7864932`, NIT 12 `81e8c06`, NIT 4 `d8141aa` (phần trong repo). |
| **Tổng** | **95** | |
